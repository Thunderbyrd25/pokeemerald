...
#define FLAG_SYS_MAP_GET                            (SYSTEM_FLAGS + 0x21) // allow player to use map menu
#define FLAG_SYS_FLY_GET                            (SYSTEM_FLAGS + 0x22) // allow player to fly menu
#define FLAG_SYS_MAP_MENU_USED                      (SYSTEM_FLAGS + 0x23) // check if map used from a map menu
